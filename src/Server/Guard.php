...
use Wise\Core\Exceptions\FaultException;
use Wise\Core\Exceptions\InvalidArgumentException;
use Wise\Core\Exceptions\RuntimeException;
use Wise\Encryption\Encryptor;
use Wise\Message\AbstractMessage;
use Wise\Message\Raw as RawMessage;
use Wise\Message\Text;
use Wise\Support\Collection;
use Wise\Support\Log;
use Wise\Support\XML;
...
class Guard
{
     ...
     * @return array
     *
     * @throws \Wise\Core\Exceptions\RuntimeException
     * @throws \Wise\Server\BadRequestException
     */
     ...
     *
     * @throws \Wise\Core\Exceptions\RuntimeException
     * @throws \Wise\Encryption\EncryptionException
     *
     * @return array
     */
