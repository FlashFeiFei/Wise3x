...
class Authorizer
{
    const CACHE_KEY_ACCESS_TOKEN = 'wise.open_platform.authorizer_access_token';
    const CACHE_KEY_REFRESH_TOKEN = 'wise.open_platform.authorizer_refresh_token';
     ...
     * Base API.
     *
     * @var \Wise\OpenPlatform\Api\BaseApi
     */
    protected $api;
     ...
     *
     * @param \Wise\OpenPlatform\Api\BaseApi $api
     ...
     * Gets the base api.
     *
     * @return \Wise\OpenPlatform\Api\BaseApi
     */
     ...
     * @return string
     *
     * @throws \Wise\Core\Exception when refresh token is not present
     */
